...
int main(){
	...
	// Integers
	std::cout << std::endl;
	std::cout << "runtime_int_rand: " << runtime_int_rand << std::endl;
	std::cout << "runtime_int_default: " << timer_rng(rng_default, dist_int, n) << std::endl;
	std::cout << "runtime_int_mt: " << timer_rng(rng_mt, dist_int, n) << std::endl;
	std::cout << "runtime_int_mt_64: " << timer_rng(rng_mt_64, dist_int, n) << std::endl;
	std::cout << "runtime_int_minstd: " << timer_rng(rng_minstd, dist_int, n) << std::endl;
	...
	// floats and doubles
	std::cout << std::endl;
	std::cout << "runtime_float_default: " << timer_rng(rng_default, dist_float, n) << std::endl;
	std::cout << "runtime_float_mt: " << timer_rng(rng_mt, dist_float, n) << std::endl;
	std::cout << "runtime_float_mt_64: " << timer_rng(rng_mt_64, dist_float, n) << std::endl;
	std::cout << "runtime_float_minstd: " << timer_rng(rng_minstd, dist_float, n) << std::endl;
	std::cout << "runtime_double_default: " << timer_rng(rng_default, dist_double, n) << std::endl;
	std::cout << "runtime_double_mt: " << timer_rng(rng_mt, dist_double, n) << std::endl;
	std::cout << "runtime_double_mt_64: " << timer_rng(rng_mt_64, dist_double, n) << std::endl;
	std::cout << "runtime_double_minstd: " << timer_rng(rng_minstd, dist_double, n) << std::endl;

	// data type limits
	// std::cout << "std::numeric_limits<int>::max(): " << std::numeric_limits<unsigned long>::max() << std::endl;
}